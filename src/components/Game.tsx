...
import type { GameProps, ScoreResult } from '../types'
import './Game.css'
...
const Game = ({ 
  ...
  const handleRouteSubmit = async (): Promise<void> => {
  ...
  // Handle map ready
  const handleMapReady = (_mapInstance: google.maps.Map): void => {
        ...
        {(game.gameState === game.GAME_STATES.ROUTE_INPUT || 
          ...
          <div className="input-section">
            <RouteInput
              ...
              onSubmit={() => void handleRouteSubmit()}
